with source as (
    select * from {{ source('src_amazon_sp_api', 'amazon_sp_api_sales_report_manufacturing') }}
),
...
renamed as (
    select
        ...
        source.ordered_revenue_currency_code as report_local_currency,
        {{ convert_lc_to_eur('ordered_revenue_amount', 'fx.FX_RATE') }}
        source.ordered_units,
